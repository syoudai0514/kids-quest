...
const MATH_LESSON_GROUPS = [
  ...
  [['fracCompareSame', 'fracCompareDiff', 'fracAddDiff', 'fracMul'], ['分数は分母が分けた数、分子がそのいくつ分かを表す', '分母が同じなら分子をくらべ、違うなら同じ分母にそろえる', '足し算で分母どうしをそのまま足さないようにしよう']],
  [['decimalAdd', 'decimalSub', 'decimalMul'], ['小数は小数点を基準に位をそろえて計算する', '2.4+0.35は2.40+0.35として2.75', '答えの小数点の位置を、計算前の見積もりで確かめよう']],
