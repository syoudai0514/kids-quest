...
const BANK = {
  ...
  6: [
    ...
    { q: '794年に 都が うつされた ところは？', a: '平安京（今の京都）', d: ['平城京', '江戸', '鎌倉'], e: '桓武天皇が 都を 平安京（今の京都）に うつしたよ' },
    { q: '『源氏物語』を 書いた 平安時代の 女性は？', a: '紫式部', d: ['清少納言', '卑弥呼', '北条政子'], e: '紫式部は 平安時代に 長い物語『源氏物語』を書いたよ' },
    { q: 'ひらがなが 生まれた 主な きっかけは？', a: '漢字を くずして 日本語を 書きやすくした', d: ['外国から そのまま伝わった', '明治政府が つくった', '江戸幕府が命令した'], e: '漢字をもとに、日本語の音を書き表しやすいひらがなが平安時代に生まれたよ' },
    ...
    { q: '戦後、日本の 工業が 大きく 発展した「高度経済成長期」は、およそ いつごろ？', a: '1950年代後半〜1970年代前半', d: ['江戸時代', '明治時代のはじめ', '2020年代'], e: '戦後の日本は、この時期に工業を中心に経済が大きく成長したよ' },
