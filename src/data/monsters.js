...
const BASE = [
  ...
  { id: 'pterry', name: 'プテリィ', role: 'friend', art: 'bird', heroStyle: 'pterry', element: 'きょうりゅう',
    colors: { body: '#ff8fb1', belly: '#ffd9e4', accent: '#fff3b0', eye: '#3a0c20' },
    desc: 'そらを とぶ よくりゅうの こ。はやさじまんで げんき。' },
  { id: 'lunaco', name: 'ルナコ', role: 'friend', art: 'ghost', heroStyle: 'lunaco', element: 'つき',
    colors: { body: '#b6a8ff', belly: '#e6dfff', accent: '#fff', eye: '#2a1f5c' },
    desc: 'つきの ひかりから うまれた、ふわふわ モンスター。' },
  { id: 'rexa', name: 'レクサ', role: 'friend', art: 'dino', heroStyle: 'rexa', element: 'きょうりゅう',
    colors: { body: '#9be36b', belly: '#d8ffba', accent: '#ff8f5e', eye: '#1d2b0c' },
    desc: 'ちいさいけど ゆうかんな りくの きょうりゅうモンスター。' },
  { id: 'cometa', name: 'コメタ', role: 'friend', art: 'star', heroStyle: 'cometa', element: 'ほし',
  ...
  { id: 'mognyu', name: 'モグニュ', role: 'wild', art: 'slime', heroStyle: 'mognyu', element: 'マグマ',
