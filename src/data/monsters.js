...
//
// 基本モンスター(BASE) + 決定論生成(GENERATED) で1000体。
...
const BASE = [
  {
    ...
    art: 'blob',
    heroStyle: 'hoshu',
    heroAsset: '/monsters/hero-hoshu.png',
  ...
  { id: 'pterry', name: 'プテリィ', role: 'friend', art: 'bird', heroStyle: 'pterry', heroAsset: '/monsters/hero-pterry.png', element: 'みず',
    colors: { body: '#ff8fb1', belly: '#ffd9e4', accent: '#fff3b0', eye: '#3a0c20' },
    desc: 'そらを とぶ よくりゅうの こ。はやさじまんで げんき。' },
  { id: 'lunaco', name: 'ルナコ', role: 'friend', art: 'ghost', heroStyle: 'lunaco', heroAsset: '/monsters/hero-lunaco.png', element: 'くさ',
    colors: { body: '#b6a8ff', belly: '#e6dfff', accent: '#fff', eye: '#2a1f5c' },
    desc: 'つきの ひかりから うまれた、ふわふわ モンスター。' },
  { id: 'rexa', name: 'レクサ', role: 'friend', art: 'dino', heroStyle: 'rexa', heroAsset: '/monsters/hero-rexa.png', element: 'でんき',
